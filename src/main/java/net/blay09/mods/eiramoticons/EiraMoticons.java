...
@Mod(modid = EiraMoticons.MOD_ID, acceptedMinecraftVersions = "[1.12]", acceptableRemoteVersions="*", guiFactory = "net.blay09.mods.eiramoticons.gui.EiraMoticonsGuiFactory", clientSideOnly = true)
